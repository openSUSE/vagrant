...
rpm --import http://download.opensuse.org/distribution/leap/15.0/repo/oss/content.key
...
rpm --import http://download.opensuse.org/distribution/leap/15.0/repo/non-oss/content.key
